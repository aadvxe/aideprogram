...
if __name__ == "__main__":
    ...
    while True:
        ...
        if frame != None:
            ...
            center_y, center_x = depth_buf.shape[0] // 2, depth_buf.shape[1] // 2
            center_distance = depth_buf[center_y, center_x] * 100  # Mengubah jarak ke cm
            print("Center distance:", center_distance, "cm")
            
            # Mengirim sinyal ke Arduino berdasarkan jarak
            if center_distance > 50:
                #ser.write(b'maju')
                print('maju')
            elif 20 <= center_distance <= 50:
